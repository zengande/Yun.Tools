...
using Yun.Tools.Core.Extensions;
...
namespace Yun.Tools.Core.IdGenerator
{
    public class SnowflakeIdGenerator : IIdGenerator
    {
        ...
        private static SnowflakeIdGenerator _snowflakeId;
        ...
        public SnowflakeIdGenerator(long workerId, long datacenterId, long sequence = 0L, int workIdBits = DEFAULT_WORKER_ID_BITS)
        {
        ...
        public static SnowflakeIdGenerator Default
        {
            get
            {
                lock (S_LOCK)
                {
                    ...
                    return _snowflakeId = new SnowflakeIdGenerator(workerId, datacenterId);
                }
            }
        }
